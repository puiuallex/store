export const produse = [
  {
    ...
    nume: "Lampă Orbită",
    descriere:
      "Corp de iluminat din PLA mat și difuzor PETG pentru o lumină caldă pe birou.",
    pret: 249,
  ...
  },
  {
    ...
    nume: "Vază Nexus",
    descriere:
      "Textură organică și stratificare vizibilă care pune în valoare florile delicate.",
    pret: 189,
  ...
  },
  {
    ...
    nume: "Tavă Flux",
    descriere:
      "Suport modular pentru birou, cu inserții magnetice pentru accesorii mici.",
    pret: 139,
    timpProductie: "1 zi",
    categorie: "Birou",
  ...
  },
  {
    ...
    descriere:
      "Cârlige aerodinamice pentru perete, gândite să suporte până la 5kg fiecare.",
    pret: 99,
    timpProductie: "1 zi",
    categorie: "Utilitar",
  ...
  },
  {
    ...
    nume: "Ghiveci Zen",
    descriere:
      "Formă ondulată inspirată de grădinile japoneze, cu rezervor intern pentru apă.",
    pret: 159,
    timpProductie: "2 zile",
    categorie: "Decor",
  ...
  },
  {
    ...
    nume: "Stand Motion",
    descriere:
      "Suport reglabil pentru laptop sau tabletă, cu nervuri interne pentru rigiditate.",
    pret: 199,
    timpProductie: "2 zile",
    categorie: "Birou",
  ...
  },
  {
    ...
    nume: "Ceas Pulse",
    descriere:
      "Cadran minimalist, numerotare perforată și mecanism silențios inclus.",
    pret: 279,
  ...
  },
  {
    ...
    descriere:
      "Set modular de cutii cu ghidaje, ideal pentru accesorii creative sau ateliere.",
    pret: 149,
    timpProductie: "1 zi",
    categorie: "Utilitar",
  ...
  },
  {
    ...
    nume: "Lampă Arc",
    descriere:
      "Lampă articulată pentru citit, cu braț imprimat în strat sub 0.15mm pentru detalii fine.",
    pret: 329,
    timpProductie: "4 zile",
    categorie: "Iluminat",
  ...
  },
  {
    ...
    descriere:
      "Pereche de suporturi parametrice care împiedică alunecarea cărților grele.",
    pret: 119,
    timpProductie: "1 zi",
    categorie: "Birou",
    ...
    imagine:
      "https://images.unsplash.com/photo-1455885666463-1c4b5d52f455?auto=format&fit=crop&w=800&q=80",
    noutate: false,
    stoc: true,
  },
];
